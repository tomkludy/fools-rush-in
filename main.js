...
var $author$project$Port$AdjustedSymbols = {$: 'AdjustedSymbols'};
...
var $author$project$LocalStore$propName = function (s) {
	return $elm$json$Json$Encode$string('ignoredSymbols');
};
var $author$project$LocalStore$propGetAdjustedSymbols = $elm$json$Json$Encode$object(
	_List_fromArray(
		[
			_Utils_Tuple2(
			'prop',
			$author$project$LocalStore$propName($author$project$Port$AdjustedSymbols))
		]));
var $author$project$LocalStore$getLocalStore = function (s) {
	return $author$project$Port$getLocalStore($author$project$LocalStore$propGetAdjustedSymbols);
};
	...
	return _Utils_Tuple2(
		{
			...
			adjustedSymbols: $elm$core$Dict$empty,
		...
		$author$project$LocalStore$getLocalStore($author$project$Port$AdjustedSymbols));
};
var $author$project$Main$RecvFromJS = function (a) {
	return {$: 'RecvFromJS', a: a};
};
...
var $author$project$Port$recvLocalStore = _Platform_incomingPort('recvLocalStore', $elm$json$Json$Decode$value);
	...
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				...
				$author$project$Port$recvLocalStore($author$project$Main$RecvFromJS)
			]));
};
var $author$project$Port$AdjustedSymbolValue = function (a) {
	return {$: 'AdjustedSymbolValue', a: a};
};
var $author$project$Main$CurrentPositionsLoaded = function (a) {
	return {$: 'CurrentPositionsLoaded', a: a};
};
var $author$project$Main$CurrentPositionsSelected = function (a) {
	return {$: 'CurrentPositionsSelected', a: a};
};
...
var $author$project$Missions$removeMission = F2(
	function (name, list) {
		return A2(
			$elm$core$List$filter,
			function (m) {
				return !_Utils_eq(m.name, name);
			},
			list);
	});
var $author$project$Missions$addMission = F2(
	function (m, list) {
		return A2(
			$elm$core$List$cons,
			m,
			A2($author$project$Missions$removeMission, m.name, list));
	});
...
var $author$project$Main$toastyConfig = A2($pablen$toasty$Toasty$delay, 5000, $pablen$toasty$Toasty$Defaults$config);
var $author$project$Main$addToast = function (toast) {
	return A3($pablen$toasty$Toasty$addToast, $author$project$Main$toastyConfig, $author$project$Main$ToastyMsg, toast);
};
var $author$project$Main$addToastError = function (error) {
	return $author$project$Main$addToast(
		A2($pablen$toasty$Toasty$Defaults$Error, 'Error', error));
};
var $pablen$toasty$Toasty$Defaults$Success = F2(
	function (a, b) {
		return {$: 'Success', a: a, b: b};
	});
var $author$project$Main$addToastSuccess = function (msg) {
	return $author$project$Main$addToast(
		A2($pablen$toasty$Toasty$Defaults$Success, 'Success', msg));
};
var $author$project$CurrentPositions$commitPendingEndCash = function (cp) {
	var _v0 = cp.pendingEndCash;
	if (_v0.$ === 'Nothing') {
		return cp;
	} else {
		var newValue = _v0.a;
		return _Utils_update(
			cp,
			{desiredEndCash: newValue, pendingEndCash: $elm$core$Maybe$Nothing});
	}
};
...
var $author$project$IntInput$IntField = F2(
	function (a, b) {
		return {$: 'IntField', a: a, b: b};
	});
var $author$project$IntInput$fromInt = function (f) {
	return A2(
		$author$project$IntInput$IntField,
		$elm$core$Maybe$Just(f),
...
var $author$project$Main$getDefaultIntInput = F2(
	function (symbol, currentPositions) {
		var defaultEndShares = $elm$core$List$sum(
			A2(
				$elm$core$List$filterMap,
				function (cp) {
					return _Utils_eq(cp.symbol, symbol) ? $elm$core$Maybe$Just(cp.quantity) : $elm$core$Maybe$Nothing;
				},
				currentPositions));
		return $author$project$IntInput$fromInt(defaultEndShares);
	});
...
var $author$project$IntInput$intValue = function (_v0) {
	var f = _v0.a;
	return f;
};
var $author$project$Transactions$Buy = {$: 'Buy'};
var $author$project$Transactions$Hold = {$: 'Hold'};
var $author$project$Transactions$None = {$: 'None'};
var $author$project$Transactions$Sell = {$: 'Sell'};
...
var $author$project$Utils$dec2 = function (f) {
	return $elm$core$Basics$round(f * 100.0) / 100.0;
};
...
var $author$project$Utils$listMerge = F3(
	function (keyFunc, combineFunc, lists) {
		return A2(
			$elm$core$List$map,
...
var $author$project$Missions$weightedPositions = F2(
	function (totalWeight, mission) {
		...
		var weighted = function (position) {
			return _Utils_update(
				position,
				{allocationPercent: position.allocationPercent * weight});
		};
		var _v0 = mission.missionPositions;
		var missionPositions = _v0.a;
		return A2($elm$core$List$map, weighted, missionPositions);
	});
var $author$project$Transactions$recalculate = F4(
	function (currentPositions, cashPosition, missions, adjustedSymbols) {
		var numOfAdjusted = function (p) {
			var _v8 = A2($elm$core$Dict$get, p.symbol, adjustedSymbols);
		...
		var costOfAdjusted = function (p) {
			var _v7 = A2($elm$core$Dict$get, p.symbol, adjustedSymbols);
			if ((_v7.$ === 'Just') && (_v7.a.$ === 'Just')) {
				var num = _v7.a.a;
				return p.lastPrice * num;
			} else {
				return p.currentValue;
			}
		};
		var adjusted = function (item) {
			return A2($elm$core$Dict$member, item.symbol, adjustedSymbols);
		};
		var notAdjusted = function (item) {
			return !adjusted(item);
		};
		var valueOfAllStartingPositions = $author$project$Utils$dec2(
			$elm$core$List$sum(
				A2(
					$elm$core$List$map,
					function ($) {
		...
		var transactionsForCurrent = A3(
			...
			F2(
				function (a, b) {
					return _Utils_update(
						a,
						{description: a.description + ' (multiple accounts)', endAmount: a.endAmount + b.endAmount, endShares: a.endShares + b.endShares, optimalAmount: a.optimalAmount + b.optimalAmount, startAmount: a.startAmount + b.startAmount, startShares: a.startShares + b.startShares});
				}),
			A2(
				$elm$core$List$map,
				function (p) {
					return {
						...
						endAmount: adjusted(p) ? costOfAdjusted(p) : 0.0,
						endShares: adjusted(p) ? numOfAdjusted(p) : 0,
						optimalAmount: adjusted(p) ? costOfAdjusted(p) : 0.0,
						price: p.lastPrice,
		...
		var totalWeight = $elm$core$List$sum(
			A2(
				...
				missions));
		var totalValue = $author$project$Utils$dec2((cashPosition.startCash + cashPosition.addCash) + valueOfAllStartingPositions);
		var oldCash = cashPosition;
		var missionPositions = $author$project$Missions$weightedPositions(totalWeight);
		var transactionsForAdjusted = A2(
			$elm$core$List$map,
			function (p) {
				return {description: p.description, endAmount: 0.0, endShares: 0, optimalAmount: 0.0, price: p.currentPrice, startAmount: 0.0, startShares: 0, symbol: p.symbol};
			},
			A2(
				$elm$core$List$filter,
				adjusted,
		...
		var transactionsForCurrentPlusAdjusted = A3(
			$author$project$Utils$listMerge,
			function ($) {
				return $.symbol;
			},
			F2(
				function (current, _v6) {
					return current;
				}),
			$elm$core$List$concat(
				_List_fromArray(
					[transactionsForCurrent, transactionsForAdjusted])));
		var desiredEndCash = function () {
			if (cashPosition.matchFool) {
				if ($elm$core$List$isEmpty(missions)) {
					return cashPosition.startCash + cashPosition.addCash;
				} else {
		...
		var costOfAdjustedPositions = $author$project$Utils$dec2(
			$elm$core$List$sum(
				A2(
					$elm$core$List$map,
					costOfAdjusted,
					A2($elm$core$List$filter, adjusted, currentPositions))));
		var totalValueForTradesAndReserve = $author$project$Utils$dec2(totalValue - costOfAdjustedPositions);
		var totalValueForTrades = $author$project$Utils$dec2(
			A2($elm$core$Basics$max, 0.0, totalValueForTradesAndReserve - desiredEndCash));
		var allNonAdjustedMissionPositions = A3(
			$author$project$Utils$listMerge,
			function ($) {
				return $.symbol;
			},
			F2(
				function (mp1, mp2) {
					return _Utils_update(
						mp1,
						{allocationPercent: mp1.allocationPercent + mp2.allocationPercent});
				}),
			A2(
				$elm$core$List$filter,
				notAdjusted,
				$elm$core$List$concat(
					A2($elm$core$List$map, missionPositions, missions))));
		var totalAllocationPercent = $elm$core$List$sum(
			A2(
				$elm$core$List$map,
				function ($) {
					return $.allocationPercent;
		...
		var scaleFactor = (totalAllocationPercent > 0.0) ? (100.0 / totalAllocationPercent) : 1.0;
		var normalizedTargetMissionPositions = A2(
			$elm$core$List$map,
			function (item) {
				return _Utils_update(
					item,
					{allocationPercent: item.allocationPercent * scaleFactor});
			},
			allNonAdjustedMissionPositions);
		var transactionsForMissions = A2(
			$elm$core$List$map,
			function (p) {
				var optimalAmount = $author$project$Utils$dec2((p.allocationPercent * totalValueForTrades) / 100.0);
				var endShares = $elm$core$Basics$round(optimalAmount / p.currentPrice);
				return {
					description: p.description,
					endAmount: $author$project$Utils$dec2(endShares * p.currentPrice),
					endShares: endShares,
		...
		var transactionsForAll = A3(
			...
			F2(
				function (current, mission) {
					return _Utils_update(
						mission,
						{startAmount: current.startAmount, startShares: current.startShares});
				}),
			$elm$core$List$concat(
				_List_fromArray(
					[transactionsForCurrentPlusAdjusted, transactionsForMissions])));
		var overage = $author$project$Utils$dec2(
			$elm$core$List$sum(
				A2(
					$elm$core$List$filterMap,
					function (t) {
						return adjusted(t) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(t.endAmount);
					},
					transactionsForAll))) - totalValueForTrades;
		var adjustment = (overage <= 0) ? $elm$core$Maybe$Nothing : A2(
			$elm$core$Maybe$map,
			function (_v5) {
				var t = _v5.a;
				var shares = _v5.b;
				return _Utils_Tuple2(t.symbol, shares);
			},
			$elm$core$List$head(
				A2(
					$elm$core$List$sortBy,
					...
					A2(
						...
						function (_v3) {
							...
							var shares = _v3.b;
							var price = _v3.c;
							return _Utils_Tuple3(t, shares, (shares * price) - overage);
						},
						A2(
							$elm$core$List$filter,
							function (_v2) {
								var t = _v2.a;
								var shares = _v2.b;
								return _Utils_cmp(t.endShares, shares) > -1;
							},
							A2(
								$elm$core$List$map,
								function (t) {
									return _Utils_Tuple3(
										t,
										$elm$core$Basics$ceiling(overage / t.price),
										t.price);
								},
								A2($elm$core$List$filter, notAdjusted, transactionsForAll)))))));
		var altered = function () {
			if (adjustment.$ === 'Nothing') {
				return transactionsForAll;
			} else {
				var _v1 = adjustment.a;
				var symbol = _v1.a;
				var shares = _v1.b;
				return A2(
					$elm$core$List$map,
					function (t) {
						return (!_Utils_eq(t.symbol, symbol)) ? t : _Utils_update(
							t,
							{
								description: t.description + (' (adjusted by ' + ($elm$core$String$fromInt(shares) + ')')),
								endAmount: $author$project$Utils$dec2((t.endShares - shares) * t.price),
		...
		var completeTransactions = A2(
			...
			function (t) {
				return {
					...
					numberOfShares: $elm$core$Basics$abs(t.startShares - t.endShares),
					...
					symbol: t.symbol,
					transType: _Utils_eq(t.startShares, t.endShares) ? ((!t.startShares) ? $author$project$Transactions$None : $author$project$Transactions$Hold) : ((_Utils_cmp(t.startShares, t.endShares) > 0) ? $author$project$Transactions$Sell : $author$project$Transactions$Buy),
					value: $author$project$Utils$dec2((t.startShares - t.endShares) * t.price)
				};
			},
			altered);
		var cashRemaining = totalValue - $elm$core$List$sum(
			A2(
				$elm$core$List$map,
				function ($) {
					return $.endAmount;
		...
		var newCash = _Utils_update(
			oldCash,
			{actualEndCash: cashRemaining, desiredEndCash: desiredEndCash});
		return {cashPosition: newCash, totalValue: totalValue, totalValueAdjusted: costOfAdjustedPositions, totalValueForTrades: totalValueForTrades, transactions: completeTransactions};
	});
var $author$project$Main$recalculate = function (_v0) {
	var model = _v0.a;
	var msg = _v0.b;
	var result = A4(
		$author$project$Transactions$recalculate,
		model.currentPositions,
		model.cash,
		model.missions,
		A2(
			$elm$core$Dict$map,
			F2(
				function (_v1, a) {
					return $author$project$IntInput$intValue(a);
				}),
			model.adjustedSymbols));
	return _Utils_Tuple2(
		_Utils_update(
			model,
			{cash: result.cashPosition, totalValue: result.totalValue, totalValueAdjusted: result.totalValueAdjusted, totalValueForTrades: result.totalValueForTrades, transactions: result.transactions}),
		msg);
};
var $author$project$Main$fixAdjustedSymbols = function (_v0) {
	var model = _v0.a;
	var msg = _v0.b;
			...
			_Utils_update(
				model,
				{
					adjustedSymbols: A2(
						...
						F2(
							function (k, _v1) {
								return A2($author$project$Main$getDefaultIntInput, k, model.currentPositions);
							}),
						model.adjustedSymbols)
				}),
			msg));
...
var $author$project$Utils$columnIdx = $elm_community$list_extra$List$Extra$elemIndex;
var $author$project$CurrentPositions$findHeaders = function (headers) {
	var midxs = _List_fromArray(
		[
			A2($author$project$Utils$columnIdx, 'Account Name/Number', headers),
			A2($author$project$Utils$columnIdx, 'Symbol', headers),
			A2($author$project$Utils$columnIdx, 'Description', headers),
			A2($author$project$Utils$columnIdx, 'Quantity', headers),
			A2($author$project$Utils$columnIdx, 'Last Price', headers),
			A2($author$project$Utils$columnIdx, 'Current Value', headers)
		]);
	if ((((((((((((midxs.b && (midxs.a.$ === 'Just')) && midxs.b.b) && (midxs.b.a.$ === 'Just')) && midxs.b.b.b) && (midxs.b.b.a.$ === 'Just')) && midxs.b.b.b.b) && (midxs.b.b.b.a.$ === 'Just')) && midxs.b.b.b.b.b) && (midxs.b.b.b.b.a.$ === 'Just')) && midxs.b.b.b.b.b.b) && (midxs.b.b.b.b.b.a.$ === 'Just')) && (!midxs.b.b.b.b.b.b.b)) {
		var accountNameCol = midxs.a.a;
		var _v1 = midxs.b;
		var symbolCol = _v1.a.a;
		var _v2 = _v1.b;
		var descriptionCol = _v2.a.a;
		var _v3 = _v2.b;
		var quantityCol = _v3.a.a;
		var _v4 = _v3.b;
		var lastPriceCol = _v4.a.a;
		var _v5 = _v4.b;
		var currentValueCol = _v5.a.a;
		return $elm$core$Maybe$Just(
			{accountNameCol: accountNameCol, currentValueCol: currentValueCol, descriptionCol: descriptionCol, lastPriceCol: lastPriceCol, quantityCol: quantityCol, symbolCol: symbolCol});
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
...
var $author$project$Utils$column = F2(
	function (row, col) {
		return A2(
			$elm$core$Maybe$withDefault,
			'',
			A2($elm_community$list_extra$List$Extra$getAt, col, row));
	});
...
var $author$project$Utils$columnFloat = F2(
	function (row, col) {
		return A2(
			$elm$core$Maybe$withDefault,
			0.0,
					...
					A3(
						...
						A3(
							...
							A3(
								...
								'$',
								'',
								A2($author$project$Utils$column, row, col)))))));
	});
		...
		return function (res) {
			...
			$elm$core$List$sum(
				A2(
					$elm$core$List$filterMap,
					function (row) {
						var _v0 = A2($author$project$Utils$column, row, headers.symbolCol);
						if (_v0 === 'FCASH**') {
							return $elm$core$Maybe$Just(
								A2($author$project$Utils$columnFloat, row, headers.quantityCol));
						} else {
							return $elm$core$Maybe$Nothing;
						}
					},
...
var $author$project$Utils$columnInt = F2(
	function (row, col) {
		return A2(
			$elm$core$Maybe$withDefault,
			0,
...
var $author$project$CurrentPositions$parsePosition = F2(
	function (headers, row) {
		var account = A2($author$project$Utils$column, row, headers.accountNameCol);
		if (A2($elm$core$String$startsWith, 'X', account)) {
			var _v0 = A2($author$project$Utils$column, row, headers.symbolCol);
			switch (_v0) {
				case 'FCASH**':
					return $elm$core$Maybe$Nothing;
				...
				default:
					...
					return $elm$core$Maybe$Just(
						{
							account: account,
							currentValue: A2($author$project$Utils$columnFloat, row, headers.currentValueCol),
							description: A2($author$project$Utils$column, row, headers.descriptionCol),
							lastPrice: A2($author$project$Utils$columnFloat, row, headers.lastPriceCol),
							quantity: A2($author$project$Utils$columnInt, row, headers.quantityCol),
							symbol: symbol
						});
			}
		} else {
...
var $author$project$CurrentPositions$mapCurrentPositions = function (value) {
	var _v0 = $author$project$CurrentPositions$findHeaders(value.headers);
	if (_v0.$ === 'Nothing') {
		return $elm$core$Result$Err('Can\'t find expected columns');
	} else {
		var headers = _v0.a;
		return $elm$core$Result$Ok(
			_Utils_Tuple2(
				A2(
					$elm$core$List$filterMap,
					$author$project$CurrentPositions$parsePosition(headers),
					value.records),
				A2($author$project$CurrentPositions$parseCash, headers, value.records)));
	}
};
...
var $author$project$CurrentPositions$parseCurrentPositions = function (content) {
	return A2(
		$elm$core$Result$andThen,
		$author$project$CurrentPositions$mapCurrentPositions,
		A2(
...
var $author$project$Missions$parseTargetLine = F3(
	function (a, b, line) {
		...
		return $elm$core$Maybe$Just(
			{
				allocationPercent: A2($author$project$Utils$columnFloat, row, 0),
				currentPrice: A2(
					$author$project$Utils$columnFloat,
					row,
					$elm$core$List$length(row) - 3),
				description: $elm$core$String$trim(a),
				symbol: symbol
			});
	});
...
var $author$project$Missions$portfolioNameRegex = A2(
	$elm$core$Maybe$withDefault,
...
var $author$project$LocalStore$propRetrieved = function (s) {
	var _v0 = A2(
		...
		if (_v0.a === 'ignoredSymbols') {
			...
			if (_v1.$ === 'Err') {
				...
				if (_v1.a.$ === 'Just') {
					...
					return $elm$core$Result$Ok(
						$elm$core$Maybe$Just(
							$author$project$Port$AdjustedSymbolValue(list)));
				} else {
					var _v2 = _v1.a;
			...
			var e = _v0.a;
			return $elm$core$Result$Err('Unknown prop ' + e);
		}
	}
};
...
var $author$project$CurrentPositions$revertPendingEndCash = function (cp) {
	return _Utils_update(
		cp,
...
var $author$project$LocalStore$propSetAdjustedSymbols = function (s) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'value',
				A2($elm$json$Json$Encode$list, $elm$json$Json$Encode$string, s))
			]));
};
var $author$project$Port$setLocalStore = _Platform_outgoingPort('setLocalStore', $elm$core$Basics$identity);
var $author$project$LocalStore$setLocalStore = function (s) {
	var list = s.a;
	return $author$project$Port$setLocalStore(
		$author$project$LocalStore$propSetAdjustedSymbols(list));
};
var $author$project$CurrentPositions$setMatchFool = F2(
	function (enable, cp) {
		return _Utils_update(
			cp,
			{matchFool: enable});
...
var $author$project$Transactions$createCsvRow = function (t) {
	return _List_fromArray(
		[
		...
		return A2(
			...
			A2(
				...
				_Utils_ap(
					...
					A2($elm$core$List$map, $author$project$Transactions$createCsvRow, transactions))));
	});
...
var $author$project$Utils$updateListItem = F3(
	function (idx, list, func) {
		return A2(
			$elm$core$List$indexedMap,
			F2(
				function (i, x) {
					return _Utils_eq(i, idx) ? func(x) : x;
				}),
			list);
	});
...
var $author$project$IntInput$fromString = function (str) {
	var f = ((str === '') || (str === '-')) ? $elm$core$Maybe$Just(0) : $elm$core$String$toInt(
		A3(
			$elm$core$String$replace,
			',',
			'',
			A3(
				...
				'',
				A3($elm$core$String$replace, '$', '', str))));
	return A2($author$project$IntInput$IntField, f, str);
};
var $author$project$IntInput$updateModel = F3(
	function (newString, updateInputField, onValidInput) {
		var field = $author$project$IntInput$fromString(newString);
		var updated = updateInputField(field);
		if (field.a.$ === 'Nothing') {
			var _v1 = field.a;
			return updated;
	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'CurrentPositionsLoaded':
				var content = msg.a;
				var _v1 = $author$project$CurrentPositions$parseCurrentPositions(content);
				if (_v1.$ === 'Err') {
					var error = _v1.a;
					return A2(
			...
			case 'AddTargetInputMsg':
				var input = msg.a;
				var _v2 = $author$project$Missions$parseMission(input);
				if (_v2.$ === 'Nothing') {
					return A2(
						$author$project$Main$addToastError,
					...
					return A2(
						...
						$author$project$Main$fixAdjustedSymbols(
			...
			case 'UpdateWeightMsg':
				...
				return $author$project$Main$recalculate(
					_Utils_Tuple2(
						...
						$elm$core$Platform$Cmd$none));
			case 'UpdateEndSharesMsg':
				var symbol = msg.a;
				var value = msg.b;
				var _v3 = A2($elm$core$Dict$get, symbol, model.adjustedSymbols);
				if (_v3.$ === 'Nothing') {
					return A2(
						$author$project$Main$addToastError,
						'Trying to update a non-adjusted symbol',
						_Utils_Tuple2(model, $elm$core$Platform$Cmd$none));
				} else {
					return $author$project$Main$recalculate(
						_Utils_Tuple2(
							_Utils_update(
								...
								{
									adjustedSymbols: A3(
										$author$project$IntInput$updateModel,
										value,
										function (f) {
											return A3($elm$core$Dict$insert, symbol, f, model.adjustedSymbols);
										},
										F2(
											function (_v4, adjustedSymbols) {
												return adjustedSymbols;
											}))
								}),
							$elm$core$Platform$Cmd$none));
				}
			case 'ChangeAdjustSymbolMsg':
				var symbol = msg.a;
				var adjust = msg.b;
				var newAdjusted = adjust ? A3(
					$elm$core$Dict$insert,
					symbol,
					A2($author$project$Main$getDefaultIntInput, symbol, model.currentPositions),
					model.adjustedSymbols) : A2($elm$core$Dict$remove, symbol, model.adjustedSymbols);
				return $author$project$Main$recalculate(
					_Utils_Tuple2(
						_Utils_update(
							model,
							{adjustedSymbols: newAdjusted}),
						$author$project$LocalStore$setLocalStore(
							$author$project$Port$AdjustedSymbolValue(
								$elm$core$Dict$keys(newAdjusted)))));
			case 'RecvFromJS':
				var incoming = msg.a;
				var _v5 = $author$project$LocalStore$propRetrieved(incoming);
				if (_v5.$ === 'Err') {
					var error = _v5.a;
					return A2(
						$author$project$Main$addToastError,
						...
						return $author$project$Main$recalculate(
							_Utils_Tuple2(
								_Utils_update(
									model,
									{
										adjustedSymbols: $elm$core$Dict$fromList(
											A2(
												$elm$core$List$map,
												function (s) {
													return _Utils_Tuple2(
														s,
														A2($author$project$Main$getDefaultIntInput, s, model.currentPositions));
												},
												list))
									}),
								$elm$core$Platform$Cmd$none));
		...
		_List_fromArray(
			[
				...
				[
					...
					_List_fromArray(
						[
							$rundis$elm_bootstrap$Bootstrap$Form$Checkbox$id('useFoolAllocationChk'),
							$rundis$elm_bootstrap$Bootstrap$Form$Checkbox$checked(c.matchFool),
							$rundis$elm_bootstrap$Bootstrap$Form$Checkbox$onCheck($author$project$Main$SwitchUseFoolAllocationMsg)
						]),
					'Use Fool allocation')
				]),
				function () {
				if (c.matchFool) {
					return _List_fromArray(
						[
							$elm$html$Html$text(
							A2($ggb$numeral_elm$Numeral$format, '$0,0.00', c.desiredEndCash))
						]);
				} else {
					var _v0 = c.pendingEndCash;
					if (_v0.$ === 'Nothing') {
						return _List_fromArray(
							[
						...
						return _List_fromArray(
							[
								...
								_List_fromArray(
									[
										$rundis$elm_bootstrap$Bootstrap$Button$onClick($author$project$Main$UpdateTargetCashMsg),
								...
								_List_fromArray(
									[
										$rundis$elm_bootstrap$Bootstrap$Button$onClick($author$project$Main$RevertTargetCashMsg),
										$rundis$elm_bootstrap$Bootstrap$Button$primary
									]),
								_List_fromArray(
									[
...
var $rundis$elm_bootstrap$Bootstrap$Table$cellPrimary = $rundis$elm_bootstrap$Bootstrap$Table$RoledCell(
	$rundis$elm_bootstrap$Bootstrap$Table$Roled($rundis$elm_bootstrap$Bootstrap$Internal$Role$Primary));
...
var $author$project$Main$currentPositionsTab = function (cp) {
	return $rundis$elm_bootstrap$Bootstrap$Tab$item(
		{
			...
			link: A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Current Positions')
					])),
			pane: A2(
				$rundis$elm_bootstrap$Bootstrap$Tab$pane,
				_List_Nil,
							...
							$rundis$elm_bootstrap$Bootstrap$Table$simpleThead(
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('Current Value')
											]))
									])),
							A2(
										...
										return A2(
											...
											_List_fromArray(
												[
													...
													_List_fromArray(
														[
															$elm$html$Html$text(p.description)
														])),
													A2(
													$rundis$elm_bootstrap$Bootstrap$Table$td,
													_List_Nil,
													...
													_List_fromArray(
														[
															$elm$html$Html$text(
															A2($ggb$numeral_elm$Numeral$format, '$0,0.00', p.lastPrice))
														])),
													A2(
													$rundis$elm_bootstrap$Bootstrap$Table$td,
													_List_Nil,
													_List_fromArray(
														[
															$elm$html$Html$text(
															A2($ggb$numeral_elm$Numeral$format, '$0,0.00', p.currentValue))
														]))
												]));
									},
									cp))))
...
var $author$project$Main$RemoveTargetRequested = function (a) {
	return {$: 'RemoveTargetRequested', a: a};
};
var $author$project$Missions$unweightedPositions = function (mission) {
	var _v0 = mission.missionPositions;
	var missionPositions = _v0.a;
	return missionPositions;
};
var $author$project$Main$SwitchUseDefaultWeightMsg = F2(
	function (a, b) {
		return {$: 'SwitchUseDefaultWeightMsg', a: a, b: b};
	});
var $author$project$Main$UpdateWeightMsg = F2(
	function (a, b) {
		return {$: 'UpdateWeightMsg', a: a, b: b};
	});
var $author$project$Utils$isNothing = function (x) {
	if (x.$ === 'Nothing') {
		return true;
	} else {
		return false;
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$elm$html$Html$text(
																A2($ggb$numeral_elm$Numeral$format, '0.0%', p.allocationPercent / 100))
															])),
														A2(
														$rundis$elm_bootstrap$Bootstrap$Table$td,
														_List_Nil,
														_List_fromArray(
															[
																$elm$html$Html$text(
																A2($ggb$numeral_elm$Numeral$format, '$0,0.00', p.currentPrice))
															]))
													]));
										},
										$author$project$Missions$unweightedPositions(mission))))),
							A2(
							$rundis$elm_bootstrap$Bootstrap$Button$button,
							_List_fromArray(
								[
									$rundis$elm_bootstrap$Bootstrap$Button$onClick(
									$author$project$Main$RemoveTargetRequested(mission)),
									$rundis$elm_bootstrap$Bootstrap$Button$primary
								]),
							_List_fromArray(
								[
									$elm$html$Html$text('Remove Target')
								]))
						]))
			});
	});
...
var $rundis$elm_bootstrap$Bootstrap$CDN$stylesheet = A3(
	...
	_List_Nil);
var $author$project$Main$ChangeAdjustSymbolMsg = F2(
	function (a, b) {
		return {$: 'ChangeAdjustSymbolMsg', a: a, b: b};
	});
...
var $author$project$Main$UpdateEndSharesMsg = F2(
	function (a, b) {
		return {$: 'UpdateEndSharesMsg', a: a, b: b};
	});
var $author$project$IntInput$intFieldValidationStyle = function (intField) {
	if (intField.a.$ === 'Nothing') {
		var _v1 = intField.a;
		var str = intField.b;
		return (str === '') ? _List_Nil : _List_fromArray(
			[
...
var $author$project$IntInput$stringValue = function (_v0) {
	var s = _v0.b;
	return s;
};
var $author$project$IntInput$intInput = F3(
	function (id, field, msg) {
		return $rundis$elm_bootstrap$Bootstrap$Form$Input$text(
			_List_fromArray(
				[
					...
					$rundis$elm_bootstrap$Bootstrap$Form$Input$small,
					$rundis$elm_bootstrap$Bootstrap$Form$Input$attrs(
					$author$project$IntInput$intFieldValidationStyle(field)),
					$rundis$elm_bootstrap$Bootstrap$Form$Input$value(
					$author$project$IntInput$stringValue(field)),
					$rundis$elm_bootstrap$Bootstrap$Form$Input$onInput(msg)
				]));
	});
var $author$project$Main$endSharesInput = F2(
	function (adjustedSymbols, symbol) {
		var input = A2($elm$core$Dict$get, symbol, adjustedSymbols);
		if (input.$ === 'Just') {
			var inp = input.a;
			return _List_fromArray(
				[
					A3(
					$author$project$IntInput$intInput,
					'endShares' + symbol,
					inp,
					$author$project$Main$UpdateEndSharesMsg(symbol))
				]);
		} else {
			return _List_fromArray(
				[
					$elm$html$Html$text('Error getting symbol input')
				]);
		}
	});
var $author$project$Main$transactionsTab = F2(
	function (adjustedSymbols, cp) {
		return $rundis$elm_bootstrap$Bootstrap$Tab$item(
			{
				id: 'tabTransactions',
				link: A2(
							...
							_Utils_Tuple2(
								$rundis$elm_bootstrap$Bootstrap$Table$simpleThead(
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$elm$html$Html$text('Trade Value')
												])),
											A2(
											$rundis$elm_bootstrap$Bootstrap$Table$th,
											_List_fromArray(
											...
											_List_fromArray(
												[
													$elm$html$Html$text('Start Shares')
												])),
											A2(
											$rundis$elm_bootstrap$Bootstrap$Table$th,
											_List_fromArray(
											...
											_List_fromArray(
												[
													$elm$html$Html$text('Start Amount')
												])),
											A2(
											$rundis$elm_bootstrap$Bootstrap$Table$th,
											_List_fromArray(
											...
											_List_fromArray(
												[
													$elm$html$Html$text('Optimal Amount')
												])),
											A2(
											$rundis$elm_bootstrap$Bootstrap$Table$th,
											_List_fromArray(
								...
								A2(
									...
									A2(
										$elm$core$List$map,
										function (p) {
											var isAdjusted = A2($elm$core$Dict$member, p.symbol, adjustedSymbols);
											return A2(
												$rundis$elm_bootstrap$Bootstrap$Table$tr,
												_List_Nil,
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																...
																_List_fromArray(
																	[
																		$rundis$elm_bootstrap$Bootstrap$Button$onClick(
																		A2($author$project$Main$ChangeAdjustSymbolMsg, p.symbol, !isAdjusted))
																	]),
																_List_Nil)
															])),
														A2(
														...
														_List_fromArray(
															[
																$elm$html$Html$text(
																$author$project$Transactions$transTypeToString(p.transType))
															])),
														A2(
														$rundis$elm_bootstrap$Bootstrap$Table$td,
														_List_Nil,
														...
														_List_fromArray(
															[
																$elm$html$Html$text(
																$elm$core$String$fromInt(p.numberOfShares))
															])),
														A2(
														$rundis$elm_bootstrap$Bootstrap$Table$td,
														_List_Nil,
														_List_fromArray(
															[
																$elm$html$Html$text(
																A2($ggb$numeral_elm$Numeral$format, '$0,0.00', p.value))
															])),
														A2(
														$rundis$elm_bootstrap$Bootstrap$Table$td,
														_List_Nil,
														_List_fromArray(
															[
																$elm$html$Html$text(
																A2($ggb$numeral_elm$Numeral$format, '$0,0.00', p.price))
															])),
														A2(
														$rundis$elm_bootstrap$Bootstrap$Table$td,
														_List_Nil,
														_List_fromArray(
															[
																$elm$html$Html$text(
																$elm$core$String$fromInt(p.startShares))
															])),
														A2(
														$rundis$elm_bootstrap$Bootstrap$Table$td,
														_List_Nil,
														_List_fromArray(
															[
																$elm$html$Html$text(
																A2($ggb$numeral_elm$Numeral$format, '$0,0.00', p.startAmount))
															])),
														A2(
														$rundis$elm_bootstrap$Bootstrap$Table$td,
														_List_Nil,
														_List_fromArray(
															[
																$elm$html$Html$text(
																A2($ggb$numeral_elm$Numeral$format, '0.0%', p.startPercent / 100.0))
															])),
														A2(
														$rundis$elm_bootstrap$Bootstrap$Table$td,
														_List_Nil,
														isAdjusted ? A2($author$project$Main$endSharesInput, adjustedSymbols, p.symbol) : _List_fromArray(
															[
																$elm$html$Html$text(
																$elm$core$String$fromInt(p.endShares))
															])),
														A2(
														$rundis$elm_bootstrap$Bootstrap$Table$td,
														_List_Nil,
														_List_fromArray(
															[
																$elm$html$Html$text(
																A2($ggb$numeral_elm$Numeral$format, '$0,0.00', p.endAmount))
															])),
														A2(
														$rundis$elm_bootstrap$Bootstrap$Table$td,
														_List_Nil,
														_List_fromArray(
															[
																$elm$html$Html$text(
																A2($ggb$numeral_elm$Numeral$format, '0.0%', p.endPercent / 100.0))
															])),
														A2(
														$rundis$elm_bootstrap$Bootstrap$Table$td,
														_List_Nil,
														_List_fromArray(
															[
																$elm$html$Html$text(
																A2($ggb$numeral_elm$Numeral$format, '$0,0.00', p.optimalAmount))
															])),
														A2(
														$rundis$elm_bootstrap$Bootstrap$Table$td,
														_List_Nil,
														_List_fromArray(
															[
																$elm$html$Html$text(
																A2($ggb$numeral_elm$Numeral$format, '0.0%', p.optimalPercent / 100.0))
															]))
													]));
										},
										cp))))
...
var $author$project$Main$view = function (model) {
	var _v0 = $elm$core$List$length(model.currentPositions);
	if (!_v0) {
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$rundis$elm_bootstrap$Bootstrap$Button$onClick($author$project$Main$CurrentPositionsRequested),
							$rundis$elm_bootstrap$Bootstrap$Button$primary
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('Load current positions')
						])),
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							'Total value (cash + stock): ' + A2($ggb$numeral_elm$Numeral$format, '$0,0.00', model.totalValue))
						])),
					A2(
					$elm$html$Html$div,
					_List_Nil,
					_List_fromArray(
						[
							$elm$html$Html$text(
							'Total reserved stock value (i.e. adjusted): ' + A2($ggb$numeral_elm$Numeral$format, '$0,0.00', model.totalValueAdjusted))
						])),
					A2(
					$elm$html$Html$div,
					_List_Nil,
					_List_fromArray(
						[
							$elm$html$Html$text(
							'Total value for trade (i.e. not adjusted or reserved as cash): ' + A2($ggb$numeral_elm$Numeral$format, '$0,0.00', model.totalValueForTrades))
						])),
					$rundis$elm_bootstrap$Bootstrap$Table$simpleTable(
					_Utils_Tuple2(
						$rundis$elm_bootstrap$Bootstrap$Table$simpleThead(
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$elm$html$Html$text('Current Cash')
										])),
									A2(
									$rundis$elm_bootstrap$Bootstrap$Table$th,
									_List_fromArray(
									...
									_List_fromArray(
										[
											$elm$html$Html$text('Desired Cash')
										])),
									A2(
									$rundis$elm_bootstrap$Bootstrap$Table$th,
									_List_fromArray(
									...
									_List_fromArray(
										[
											$elm$html$Html$text('Actual End Cash')
										])),
									A2(
									$rundis$elm_bootstrap$Bootstrap$Table$th,
									_List_fromArray(
											...
											[
												...
												_List_fromArray(
													[
														A2(
														$elm$html$Html$div,
														(_Utils_cmp(model.cash.actualEndCash, model.cash.desiredEndCash) < 0) ? _List_fromArray(
															[
							...
							$elm$core$List$isEmpty(model.missions) ? _List_Nil : $elm$core$List$concat(
								_List_fromArray(
									[
										_List_fromArray(
										[
											A2($author$project$Main$transactionsTab, model.adjustedSymbols, model.transactions),
