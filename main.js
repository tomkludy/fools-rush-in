...
var $author$project$LocalStore$propGetIgnoredSymbols = $elm$json$Json$Encode$object(
	_List_fromArray(
		[
			_Utils_Tuple2(
			'prop',
			$author$project$LocalStore$propName($author$project$Port$IgnoredSymbols))
		]));
...
var $author$project$Port$IgnoredSymbolValue = function (a) {
	return {$: 'IgnoredSymbolValue', a: a};
};
		...
		if (_v0.a === 'ignoredSymbols') {
			...
			if (_v1.$ === 'Err') {
				...
				if (_v1.a.$ === 'Just') {
					...
					return $elm$core$Result$Ok(
						$elm$core$Maybe$Just(
							$author$project$Port$IgnoredSymbolValue(list)));
				} else {
					var _v2 = _v1.a;
...
var $author$project$Transactions$Ignore = {$: 'Ignore'};
...
var $author$project$Transactions$recalculate = F4(
	function (currentPositions, cashPosition, missions, ignoredSymbols) {
		var ignored = function (item) {
			return A2($elm$core$List$member, item.symbol, ignoredSymbols);
		};
		var notIgnored = function (item) {
			return !ignored(item);
		};
		var valueOfNonIgnoredPositions = A2(
			$elm$core$Debug$log,
			'valueOfNonIgnoredPositions',
			$author$project$Utils$dec2(
				$elm$core$List$sum(
					A2(
						$elm$core$List$map,
						function ($) {
						...
						A2($elm$core$List$filter, notIgnored, currentPositions)))));
		var valueOfIgnoredPositions = A2(
			$elm$core$Debug$log,
			...
			$author$project$Utils$dec2(
				$elm$core$List$sum(
					A2(
						...
						A2($elm$core$List$filter, ignored, currentPositions)))));
		var valueOfAllPositions = A2(
			$elm$core$Debug$log,
			'valueOfAllPositions',
			$author$project$Utils$dec2(
				$elm$core$List$sum(
				...
				A2(
					...
					function (p) {
						return {
							...
							endAmount: ignored(p) ? p.currentValue : 0.0,
							endShares: ignored(p) ? p.quantity : 0,
							optimalAmount: ignored(p) ? p.currentValue : 0.0,
							price: p.lastPrice,
		...
		var totalWeight = A2(
			...
			$elm$core$List$sum(
				A2(
					...
					missions)));
		var totalValueNotIgnored = A2(
			$elm$core$Debug$log,
			'totalValueNotIgnored',
			$author$project$Utils$dec2((cashPosition.startCash + cashPosition.addCash) + valueOfNonIgnoredPositions));
		var totalValue = A2(
			$elm$core$Debug$log,
			'totalValue',
			$author$project$Utils$dec2((cashPosition.startCash + cashPosition.addCash) + valueOfAllPositions));
		...
		var transactionsForCurrentPlusIgnored = A2(
			$elm$core$Debug$log,
		...
		var totalValueForTrades = A2(
			$elm$core$Debug$log,
			'totalValueForTrades',
			$author$project$Utils$dec2(totalValueNotIgnored - desiredEndCash));
		var allNonIgnoredMissionPositions = A2(
			$elm$core$Debug$log,
		...
		var scaleFactor = A2(
			$elm$core$Debug$log,
			'scaleFactor',
			(totalAllocationPercent > 0.0) ? (100.0 / totalAllocationPercent) : 1.0);
		...
		var transactionsForAll = A2(
			...
			A3(
				...
				$elm$core$List$concat(
					_List_fromArray(
						[transactionsForCurrentPlusIgnored, transactionsForMissions]))));
		var overage = A2(
			$elm$core$Debug$log,
			'overage',
			$author$project$Utils$dec2(
				$elm$core$List$sum(
					A2(
						$elm$core$List$filterMap,
						function (t) {
							return ignored(t) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(t.endAmount);
						},
						transactionsForAll))) - totalValueForTrades);
		var adjustment = A2(
			$elm$core$Debug$log,
			'adjustment',
			(overage <= 0) ? $elm$core$Maybe$Nothing : A2(
				$elm$core$Maybe$map,
				function (_v5) {
					var t = _v5.a;
					var shares = _v5.b;
								...
								A2(
									...
									A2(
										...
										A2(
											...
											A2($elm$core$List$filter, notIgnored, transactionsForAll))))))))));
		...
		var completeTransactions = A2(
			...
			function (t) {
				return {
					...
					symbol: t.symbol,
					transType: ignored(t) ? $author$project$Transactions$Ignore : (_Utils_eq(t.startShares, t.endShares) ? $author$project$Transactions$Hold : ((_Utils_cmp(t.startShares, t.endShares) > 0) ? $author$project$Transactions$Sell : $author$project$Transactions$Buy)),
		...
		return {cashPosition: newCash, totalValue: totalValue, totalValueForTrades: totalValueForTrades, totalValueIgnored: valueOfIgnoredPositions, transactions: completeTransactions};
	});
var $author$project$Main$recalculate = function (_v0) {
	var model = _v0.a;
	var msg = _v0.b;
	var result = A4($author$project$Transactions$recalculate, model.currentPositions, model.cash, model.missions, model.ignoredSymbols);
	return _Utils_Tuple2(
		_Utils_update(
			model,
			{cash: result.cashPosition, totalValue: result.totalValue, totalValueForTrades: result.totalValueForTrades, totalValueIgnored: result.totalValueIgnored, transactions: result.transactions}),
		msg);
};
...
var $author$project$LocalStore$propSetIgnoredSymbols = function (s) {
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
...
var $author$project$LocalStore$setLocalStore = function (s) {
	...
	return $author$project$Port$setLocalStore(
		$author$project$LocalStore$propSetIgnoredSymbols(list));
};
...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'RecvFromJS':
				var incoming = msg.a;
				var _v3 = $author$project$LocalStore$propRetrieved(incoming);
				if (_v3.$ === 'Err') {
					var error = _v3.a;
					return A2(
						$author$project$Main$addToastError,
...
var $rundis$elm_bootstrap$Bootstrap$CDN$stylesheet = A3(
	...
	_List_Nil);
var $author$project$Main$ChangeIgnoreSymbolMsg = F2(
	function (a, b) {
							...
							_Utils_Tuple2(
								...
								A2(
									...
									A2(
										$elm$core$List$map,
										function (p) {
											var isIgnored = A2($elm$core$List$member, p.symbol, ignoredSymbols);
											return A2(
												$rundis$elm_bootstrap$Bootstrap$Table$tr,
												_List_Nil,
												_List_fromArray(
														...
														_List_fromArray(
															[
																...
																_List_fromArray(
																	[
																		$rundis$elm_bootstrap$Bootstrap$Button$onClick(
																		A2($author$project$Main$ChangeIgnoreSymbolMsg, p.symbol, !isIgnored))
																	]),
																_List_Nil)
															])),
														A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							'Total reserved stock value (i.e. owned and ignored): ' + A2($ggb$numeral_elm$Numeral$format, '$0,0.00', model.totalValueIgnored))
						])),
					A2(
					$elm$html$Html$div,
					_List_Nil,
					_List_fromArray(
						[
							$elm$html$Html$text(
							'Total value for trade (i.e. not ignored or reserved as cash): ' + A2($ggb$numeral_elm$Numeral$format, '$0,0.00', model.totalValueForTrades))
						])),
					$rundis$elm_bootstrap$Bootstrap$Table$simpleTable(
					_Utils_Tuple2(
						$rundis$elm_bootstrap$Bootstrap$Table$simpleThead(
...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{"Missions.Mission":{"args":[],"type":"{ name : String.String, missionPositions : Missions.Private, weight : Maybe.Maybe Basics.Float, defaultWeight : Basics.Float, weightInput : FloatInput.FloatField }"},"Json.Decode.Value":{"args":[],"type":"Json.Encode.Value"},"Toasty.Id":{"args":[],"type":"Basics.Int"},"Missions.MissionPosition":{"args":[],"type":"{ symbol : String.String, description : String.String, currentPrice : Basics.Float, allocationPercent : Basics.Float }"}},"unions":{"Main.Msg":{"args":[],"tags":{"CurrentPositionsRequested":[],"CurrentPositionsSelected":["File.File"],"CurrentPositionsLoaded":["String.String"],"TabMsg":["Bootstrap.Tab.State"],"AddTargetInputMsg":["String.String"],"ToastyMsg":["Toasty.Msg Toasty.Defaults.Toast"],"RemoveTargetRequested":["Missions.Mission"],"SwitchUseFoolAllocationMsg":["Basics.Bool"],"UpdatePendingTargetCashMsg":["String.String"],"UpdateTargetCashMsg":[],"RevertTargetCashMsg":[],"UpdateAddCashMsg":["String.String"],"SwitchUseDefaultWeightMsg":["Basics.Int","Basics.Bool"],"UpdateWeightMsg":["Basics.Int","String.String"],"ChangeIgnoreSymbolMsg":["String.String","Basics.Bool"],"RecvFromJS":["Json.Decode.Value"],"DownloadTransactionsMsg":[]}},"Basics.Bool":{"args":[],"tags":{"True":[],"False":[]}},"File.File":{"args":[],"tags":{"File":[]}},"Basics.Float":{"args":[],"tags":{"Float":[]}},"FloatInput.FloatField":{"args":[],"tags":{"FloatField":["Maybe.Maybe Basics.Float","String.String"]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Toasty.Msg":{"args":["a"],"tags":{"Add":["a"],"Remove":["Toasty.Id"],"TransitionOut":["Toasty.Id"]}},"Missions.Private":{"args":[],"tags":{"Private":["List.List Missions.MissionPosition"]}},"Bootstrap.Tab.State":{"args":[],"tags":{"State":["{ activeTab : Maybe.Maybe String.String, visibility : Bootstrap.Tab.Visibility }"]}},"String.String":{"args":[],"tags":{"String":[]}},"Toasty.Defaults.Toast":{"args":[],"tags":{"Success":["String.String","String.String"],"Warning":["String.String","String.String"],"Error":["String.String","String.String"]}},"Json.Encode.Value":{"args":[],"tags":{"Value":[]}},"List.List":{"args":["a"],"tags":{}},"Bootstrap.Tab.Visibility":{"args":[],"tags":{"Hidden":[],"Start":[],"Showing":[]}}}}})}});}(this));